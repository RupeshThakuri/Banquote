...
export default function Testimonial() {
    ...
    //data for customer review
    const customerReviewData = [
        {
            id: 1,
            name: "Sarah M.",
            desc: "BNQuotes made it so easy to find the perfect banquet quote for my client's wedding. The platform is incredibly user-friendly, and I was able to compare quotes from multiple venues in just a few clicks. Thanks to BNQuotes, I found the ideal location within our budget, and the wedding was a huge success!",
            pos: "Wedding Planner",
        },
        {
            id: 2,
            name: "John D.",
            desc: "I’ve been organizing corporate events for years, and BNQuotes has been a game-changer. The variety of banquet quotes and options available on the platform helped me find the best venue for our conference. The site made the entire process smooth and hassle-free, and I’ll definitely use it for future events.",
            pos: "Event Organizer",
        },
        {
            id: 3,
            name: "Emily R.",
            desc: "Planning a wedding can be stressful, but BNQuotes made finding the right banquet hall a breeze. I loved how I could filter quotes based on my budget and specific needs. The site gave me peace of mind knowing I was getting competitive prices from trusted venues. I highly recommend it!",
            pos: "Bride-to-Be",
        },
        {
            id: 4,
            name: "Michael T.",
            desc: "I used BNQuotes for my daughter’s sweet sixteen party, and I was blown away by the options available. The platform made comparing different venues and their services so easy. I was able to find the perfect banquet location that fit both our budget and our vision for the event. Very satisfied!",
            pos: "Birthday Party Host",
        },
        {
            id: 5,
            name: "Laura H.",
            desc: "BNQuotes is the ultimate tool for finding banquet quotes. As an event coordinator, time is precious, and this site saved me so much time by giving me direct access to quotes from top banquet providers. It’s efficient, reliable, and a must-have for anyone organizing an event.",
    ...
    return (
        <>
            ...
            <div className="testimonials overflow-hidden py-5 ">
                <h2 className="mb-4 text-xl font-semibold text-center">
                    We Value Our Customer Openion
                </h2>
